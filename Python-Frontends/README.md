...
2. [**Understanding API-Based Architecture (Restaurant Example)**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p02.md)
...
3. [**Overview of Python Frontend Options**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p03.md)
...
4. [**How Codex Helps in Frontend Development**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p04.md)
...
5. [**Basic Tools Setup**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p05.md)
...
6. [**API Basics for Frontend Developers**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p06.md)
...
7. [**Using Python to Call REST APIs**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p07.md)

   * Using `requests` (sync) with simple examples.
   * Using `httpx` / `aiohttp` (async) in simple language.
   * Handling success, errors, and timeouts.

8. [**Designing Simple Backend APIs for Frontend Use**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p08.md)
...
9. [**Using Codex to Design API Contracts**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p09.md)
...
10. [**Form Basics – Collecting Data from Users**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p10.md)

    * Text boxes, dropdowns, radio buttons, checkboxes.
    * Required vs optional fields.
    * Real-life example: “New Patient Registration” form.

11. [**Building Forms in Streamlit**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p11.md)
...
12. [**Building Forms in Gradio**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p12.md)

    * Creating input components.
    * Binding a function that calls backend API.
    * Simple example: “Check account balance” or “Book a service”.

13. [**Building Forms in NiceGUI**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p13.md)

    * Using `ui.input`, `ui.button`, `ui.select`.
    * Event handlers that call backend via `requests` / `httpx`.
    * Simple layout: column, row, cards.

14. [**Client-Side Validation vs Server-Side Validation**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p14.md)
...
15. [**Using Codex to Generate and Refine Form Code**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p15.md)
...
16. [**Dashboard Basics – Showing Data Clearly**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p16.md)
...
17. [**Fetching Lists and Tables from APIs**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p17.md)

    * Calling `/items` or `/patients` APIs.
    * Handling pagination: page number, page size.
    * Sorting and filtering on the frontend.

18. [**Tables and Data Grids in Streamlit / NiceGUI**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p18.md)

    * Using `st.table` / `st.dataframe`.
    * NiceGUI table and pagination.
    * Adding simple search box and filter dropdown.

19. [**Building Charts from API Data**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p19.md)
...
20. [**Refreshing Data and Auto-Update**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p20.md)

    * Manual refresh button.
    * Simple auto-refresh (timer-like).
    * Handling loading states: showing spinner or “Loading…” message.

21. [**Using Codex to Build Dashboards Faster**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p21.md)
...
22. [**State in Frontends – Remembering Things Between Actions**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p22.md)
...
23. [**Managing State in Streamlit / NiceGUI**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p23.md)

    * Streamlit’s `st.session_state`.
    * NiceGUI’s state with variables and classes.
    * Avoiding ‘reset’ problems when user interacts.

24. [**Routing and Multi-Page Apps**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p24.md)

    * Simple idea: each screen is like a “room” in a house.
    * Streamlit multi-page apps.
    * NiceGUI router and page paths (`/login`, `/dashboard`, `/profile`).

25. [**Building a Simple Menu & Navigation Bar**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p25.md)

    * Sidebar menu with pages.
    * Top navigation bar with tabs.
    * Changing visible content based on selected menu item.

26. [**User Roles & Conditional UI (Admin vs Normal User)**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p26.md)
...
27. [**Using Codex to Organize UI Structure**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p27.md)
...
28. [**Login and Token Basics**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p28.md)
...
29. [**Implementing Login Forms in Python Frontends**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p29.md)

    * Login screen with username/password.
    * Call `/auth/login` API, handle success/failure.
    * Save token in session state and use for further API calls.

30. [**Calling Protected APIs from the Frontend**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p30.md)
...
31. [**Handling Sensitive Data Safely in the UI**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p31.md)

    * Avoid logging full tokens.
    * Never store tokens in public places.
    * Masking certain fields on screen (like partial ID numbers).

32. [**Using Codex to Add Security-Related Code**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p32.md)
...
33. [**Error Handling on the Frontend**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p33.md)
...
34. [**Form Error Messages and Validation Feedback**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p34.md)
...
35. [**Loading States, Spinners, and Disabled Buttons**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p35.md)

    * Disable submit button during API call.
    * Show spinner or progress while waiting.
    * Prevent multiple submissions.

36. [**Basic Performance Ideas**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p36.md)
...
37. [**Using Codex as an “Error Doctor”**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p37.md)
...
38. [**Basic Layout Principles for Business Apps**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p38.md)

    * Group related inputs together.
    * Clear headings and sections.
    * Consistent button positions (e.g., “Save” at bottom right).

39. [**Styling Streamlit and NiceGUI Apps**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p39.md)

    * `st.columns`, `st.container`, etc.
    * NiceGUI cards, dialogs, layout components.
    * Light CSS tweaks where needed (very simple).

40. [**Creating Reusable UI Components**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p40.md)

    * Reusable form component (e.g., PatientForm).
    * Reusable table + filter component.
    * Reusable chart wrapper for given API.

41. [**Using Codex to Build and Refine Components**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p41.md)
...
42. [**Project 1: Simple Customer Management System**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p42.md)
...
43. [**Project 2: Sales Dashboard with Filters**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p43.md)
...
44. [**Project 3: Clinic Frontend (Tied to AI/ML Backend)**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p44.md)
...
45. [**Project 4: File Upload + Processing App**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p45.md)
...
46. [**Configuration & Environment Management**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p46.md)

    * `config.py` or `.env` for API URLs, keys.
    * Switching between dev and prod backend URLs.
    * Keeping secrets outside of code.

47. [**Writing Documentation for Frontend Users**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p47.md)
...
48. [**Using Codex to Generate Docs and Comments**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p48.md)

    * Requesting clean docstrings.
    * Generating Markdown documentation from code comments.
    * Keeping code and docs in sync using Codex.

49. [**Packaging the App for Others to Run**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p49.md)

    * Requirements file.
    * Simple startup script (`run_frontend.py`).
    * Folder structure: `frontend/`, `backend/`, `common/`.

50. [**Deploying Python Frontends**](https://github.com/fromsantanu/Codex-Development/blob/main/Python-Frontends/p50.md)
